...
<html lang="en">
  ...
  ?>
      ...
      <!-- Activity section -->
            <div class="row activity text-center">
                  ...
                  <div class="col-md act">
                    ...
                    <br>
                    <a href="transfermoney.php"><button style="background-color : green;">Make Transaction</button></a>
                  </div>
                  <div class="col-md act">
      ...
      <footer class="text-center mt-5 py-2"  style="background-color: lightblue">
        <p>Made by <b>MEET KADIYA</b> <br> THE SPARK FOUNDATION</p>
      </footer>
